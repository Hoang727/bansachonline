			...
			<div class="row">
				<div class="col-lg-12">
					...
					<?php 
						...
						$id = $_GET['id'];
						$laydanhsachnhasx="SELECT * from nhaxuatban where  id = '$id' ";
						$rstennhasx = $conn->query($laydanhsachnhasx);
							  $row2 = $rstennhasx->fetch_assoc();
								$tennhasx = $row2["Ten"];
						?>
					<li><a href="sach.php"><?php echo $tennhasx?></a></li>
					</ul>
				</div>
			</div>
...
?>
								...
								<div class="caption">
									<div class="name" style="height: 49px;"><h3><a href="product.php?id=<?php echo $row["ID"]?>"><?php echo $row["Ten"]?></a></h3></div>
									<?php
