...
<?php 
	...
	<div id="page-content" class="single-page">
		<div class="container">
			...
			<center>
			<p style="color:red; font-size: 25px;" ><i class="fa fa-exclamation" aria-hidden="true"> Bạn cần đăng nhập để đặt hàng</i></p>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-8">
					...
					<div class="tongcong" style="border-top: 1px solid black; color: black; font-size: 20px	;">Tổng cộng <p><?php echo $total ?>.000 VNĐ</p> </div>
					</div>
				</div>
				</div>
		</div> 
