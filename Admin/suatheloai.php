...
?>
   ...
   $id = $_GET["id"];
   $query="SELECT matheloai,Ten from theloai where matheloai =".$id;
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="<?php include 'xulysuatheloai.php' ?>">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <input type="hidden" class="form-control" name="id" value="<?php echo $row["matheloai"] ?>">
                      </div>
                    </div>
     
                  <div class="box-footer">
                  <a href="qlytheloai.php"><button type="button" name="cancel" class="btn btn-default">Cancel</button></a>
